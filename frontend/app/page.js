...
export default function Home() {
  return (
    <div className="w-full bg-[#04060d] text-white flex flex-col font-sans relative select-none">
      {/* Background stadium video is memoized so that parent updates do not restart play */}
      <BackgroundVideo />

      {/* Retro-themed gradient overlays span the full page height to unify the sections */}
      ...
      {/* Cyberpunk accent glows sit in the background below the fold */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 min-h-screen relative z-10 w-full">
        {/* Left side is the main hero copy and the flat partner branding deck */}
        ...
        {/* Right side is the floating dashboard consisting of live bidding board and leaderboard */}
