...
export default function Header({
  ...
  subtitle = "Complete challenges, earn μPoints and climb the tiers.",
}) {
  return (
    <header className="w-full flex items-center justify-between border-b border-white/5 pb-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          ...
          className="w-9 h-9 rounded-xl border border-white/5 bg-slate-900/60 hover:bg-white/5 transition-all flex items-center justify-center cursor-pointer text-slate-400 hover:text-white"
