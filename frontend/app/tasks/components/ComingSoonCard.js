export default function ComingSoonCard() {
  return (
    <div className="flex flex-col items-center justify-center p-10 bg-[#110e24]/80 border border-white/5 rounded-2xl backdrop-blur-md shadow-2xl max-w-md mx-auto w-full text-center relative overflow-hidden animate-fade-in">
      ...
      <span className="bg-gradient-to-r from-slate-400 via-slate-200 to-slate-500 text-slate-950 border border-white/20 text-[9px] font-black px-2.5 py-1 rounded-md uppercase tracking-wider shadow-[0_1px_3px_rgba(0,0,0,0.3)] leading-none select-none mb-4">
        TIER 2 ELITE
      </span>
      ...
      <p className="text-[10px] text-slate-400 font-medium leading-relaxed max-w-xs">
        Tier 2 tasks will be released later. Get ready to level up your favorite team with elite progression challenges!
      </p>
    </div>
  );
}
