      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-stretch mt-2">
        ...
        <div className="md:col-span-4 bg-[#110e20]/60 border border-white/5 rounded-2xl p-4 flex items-center gap-4 shadow-md">
          <div className="w-12 h-12 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center shadow-[0_0_15px_rgba(245,158,11,0.15)] shrink-0">
            <div className="w-7 h-7 rounded-full bg-gradient-to-r from-yellow-400 to-amber-500 flex items-center justify-center shadow-[0_0_8px_rgba(251,191,36,0.5)]">
              <span className="text-xs font-black text-slate-950">u</span>
            </div>
          </div>
          <div className="flex flex-col">
            <span className="text-xl font-black text-white leading-none">25</span>
            <span className="text-[9px] font-black uppercase tracking-wider text-slate-500 mt-1">uPoints</span>
          </div>
        </div>
        ...
        <div className="md:col-span-4 bg-[#110e20]/60 border border-white/5 rounded-2xl p-4 flex items-center gap-4 shadow-md">
          <div className="w-12 h-12 rounded-xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center shadow-[0_0_15px_rgba(139,92,246,0.15)] shrink-0">
            <svg className="w-6 h-6 text-violet-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-12v.75m0 3v.75m0 3v.75m0 3V18M3 6h18M3 18h18M3 6.75A1.75 1.75 0 014.75 5h14.5A1.75 1.75 0 0121 6.75v10.5a1.75 1.75 0 01-1.75 1.75H4.75A1.75 1.75 0 013 17.25V6.75z" />
            </svg>
          </div>
          <div className="flex flex-col">
            <span className="text-xl font-black text-white leading-none">1</span>
            <span className="text-[9px] font-black uppercase tracking-wider text-slate-500 mt-1">Arena Ticket</span>
          </div>
        </div>
        ...
        <div className="md:col-span-4 bg-gradient-to-r from-violet-900/40 via-indigo-900/30 to-slate-900/50 border border-violet-500/20 rounded-2xl p-4 flex items-center justify-between shadow-lg relative overflow-hidden group">
          ...
          <div className="flex flex-col gap-1.5 z-10">
            <span className="text-[8px] font-black text-violet-400 uppercase tracking-widest leading-none">Complete Tier 1</span>
