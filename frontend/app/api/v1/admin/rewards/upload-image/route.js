...
let rewardBucketReady = false;

export async function POST(request) {
  try {
    // 1. Authenticate admin/merch partner
    ...
    const filePath = `reward-${Date.now()}.${extension}`;
    ...
    console.error("Reward image upload handler error:", error);
    return NextResponse.json(
