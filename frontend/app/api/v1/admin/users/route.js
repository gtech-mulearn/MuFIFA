...
export async function GET(request) {
  try {
    ...
    const url = `${supabaseUrl}/rest/v1/registrations?select=id,name,email,user_id,phone,domain,team,mu_points,created_at&order=created_at.desc&offset=${offset}&limit=${limit}${filterQuery}`;
