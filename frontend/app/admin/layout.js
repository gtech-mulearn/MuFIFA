...
function Sidebar({ admin, collapsed, setCollapsed }) {
  ...
  const links = [
    ...
    { name: "Preview Tasks", href: "/admin/tasks/preview", icon: <PreviewIcon /> },
  ...
  if (admin?.role === "iglead") {
    const igLeadAllowed = ["/admin", "/admin/tasks", "/admin/tasks/create", "/admin/tasks/preview", "/admin/tasks/sync"];
