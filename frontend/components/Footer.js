...
export default function Footer() {
  return (
    <footer className="relative w-full mt-auto border-t border-white/5 bg-glass-card backdrop-blur-md overflow-hidden z-20">
      {/* Background glowing gradients for footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
          ...
          <div className="md:col-span-7 flex flex-col gap-4 text-left">
            ...
            <p className="text-xs text-slate-400 max-w-sm leading-relaxed">
              ...
              Complete technical drills, wager µ-Coins, and lead your squad to
          ...
          {/* Center Column: Quick Navigation Links (span 5) */}
      ...
      {/* Absolute Revolving Football and Glow Ring stuck to the right edge (only 3/4 visible) */}
      <div className="absolute right-0 top-8 -translate-y-1/2 translate-x-[25%] flex flex-col items-center justify-center h-40 w-40 pointer-events-none select-none z-10 overflow-visible">
        {/* Spinning/pulsing neon gradient glow backdrop */}
        ...
        {/* Revolving cyber football container */}
